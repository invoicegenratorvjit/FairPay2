        ...
        if (validator.notNull(newGroup.groupName) &&
            ...
            */
            ...
            for (var user of newGroup.groupMembers) {
                ...
                var memberCheck = await validator.userValidationPhone(user)
                console.log("member check",memberCheck,user)
                if (!memberCheck) {
            ...
            */
            ...
            var ownerCheck = await validator.userValidationPhone(newGroup.groupOwner)
            if (!ownerCheck) {
